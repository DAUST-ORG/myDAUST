// All copy + data for the DAUST public site, ported verbatim from
// design/DAUST website redesign/DAUST Website.dc.html (the renderVals() data object).
// EN/FR are swapped by the `lang` argument.
