...
function statusDescription(view: OperatingBudgetView): string {
  ...
  if (revision.status === "pending")
    return "This revision is locked while an administrator reviews the submitted plan.";
  ...
  return "Draft changes are visible only to Finance until submitted for administrator approval.";
}
...
export default function BudgetingCashflowPage() {
  ...
  async function persistBudget(action: "save" | "submit") {
    ...
    if (!reason.trim()) {
      setError(
        action === "submit"
          ? "Explain why this budget revision is being submitted."
  ...
  async function confirmVoid() {
    ...
    try {
      ...
      setVoidError(
        cause instanceof Error
          ? cause.message
          : "Could not submit this void request.",
      );
    } finally {
      setVoidBusy(false);
    }
  ...
  if (loading && !data) {
    return (
      <div className={styles.page}>
        <PageHeader
          eyebrow="Finance · Operating plan"
    ...
    <div className={styles.page}>
          ...
          <div className={styles.toolbar}>
            ...
            {isEditing ? (
              <>
                ...
                >
                  {isAdmin ? "Approve revision" : "Submit for approval"}
                </Button>
              </>
            ) : (
              <Button
      ...
      <div className={styles.statusBanner}>
        ...
        <div className={styles.statusMeta}>
          ...
          {status === "pending" && (
            <Link
              href={isAdmin ? "/director/approvals" : "/finance/requests"}
        ...
        <div key={warning.code} className={styles.warning} role="status">
          ...
          {warning.code === "unclassified_expenses" ? (
            <span>
              ...
              cash and closing totals. Open their Actual cells and request an
              edit to assign a management category.
            </span>
        ...
        {isEditing && tab === "budget" && (
          <div className={styles.reasonPanel}>
            ...
            <p>
              ...
              keeps this private; submission sends the complete revision for
          ...
          <>
            <p className={styles.drawerIntro}>
              ...
              {actualSelection.row.categoryKey === "unclassified_expenses"
                ? " Open an expense below and request an edit to classify it. Cell-level adjustments and new entries are unavailable until classification."
        ...
        title={
          actionMode === "manual_income"
            ...
            : actionMode === "expense"
              ...
              : actionMode === "adjustment"
                ? "Request actual adjustment"
                : actionMode === "edit_income"
                  ? "Request income edit"
                  : "Request expense edit"
        }
        footer={
          <>
            <Button
        ...
        {actionForm && (
          <div className={styles.form}>
            ...
            <div className={styles.approvalNote}>
              ...
              <span>
                Source transactions are never overwritten. This request records
                the before and after values and requires administrator approval.
              </span>
            </div>
          </div>
        )}
        ...
        {voidEntry && (
          <div className={styles.form}>
            <p className={styles.drawerIntro}>
              ...
              history. The ledger changes only after administrator approval.
            </p>
            {voidError && (
              <div className={styles.error} role="alert">
