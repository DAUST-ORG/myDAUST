...
export const PAGE_META: Record<string, { title: string; crumb: string }> = {
  ...
  "/admin/directory": { title: "Directory", crumb: "Faculty & staff directory · Administration" },
  "/admin/staff": { title: "Roles & Permissions", crumb: "Role-based access control · Administration" },
